...
The parametric types `typing.Tuple`, `typing.List`, `typing.Dict`, and
`typing.Iterable` can be used to dispatch on respectively tuples, lists,
dictionaries, and iterables with particular types of elements.
